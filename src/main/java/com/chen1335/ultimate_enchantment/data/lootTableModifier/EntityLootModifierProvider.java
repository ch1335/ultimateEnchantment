package com.chen1335.ultimate_enchantment.data.lootTableModifier;
...
public class EntityLootModifierProvider extends GlobalLootModifierProvider {
    ...
    private static ResourceKey<LootTable> key(String pName) {
        return ResourceKey.create(Registries.LOOT_TABLE, Identifier.fromNamespaceAndPath(UltimateEnchantment.MODID, pName));
    }
