package com.chen1335.ultimate_enchantment.data.lootTable;
...
//            );
        ...
        private static ResourceKey<LootTable> registerModifier(Identifier resourceLocation) {
            return ResourceKey.create(Registries.LOOT_TABLE, Identifier.fromNamespaceAndPath(UltimateEnchantment.MODID, resourceLocation.getPath() + "_modifier"));
        }
    }

    private static ResourceKey<LootTable> register(String name) {
        return ResourceKey.create(Registries.LOOT_TABLE, Identifier.fromNamespaceAndPath(UltimateEnchantment.MODID, name));
    }
}
