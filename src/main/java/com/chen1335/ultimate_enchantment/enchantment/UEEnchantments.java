...
import com.chen1335.ultimate_enchantment.enchantment.enchantments.CutDown;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.DoubleHook;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.EtherealArrow;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.Harvest;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.HurtDeepens;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.KineticEnergy;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.LethalTempo;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.LifeSteal;
...
import com.chen1335.ultimate_enchantment.enchantment.enchantments.LastStand;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.Legend;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.OverGrow;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.QuickShooting;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.PierceThrough;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.Scabbing;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.QuickLatch;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.Smelting;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.Eternal;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.UltimateSlayer;
import com.chen1335.ultimate_enchantment.enchantment.enchantments.TheFortress;
...
public class UEEnchantments {
    ...
    private static <T extends EnchantmentBasic> T register(T enchantment) {
        ...
        Path file = directory.resolve(key.identifier().getPath() + ".json").normalize();
