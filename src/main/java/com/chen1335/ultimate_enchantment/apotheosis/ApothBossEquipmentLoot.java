package com.chen1335.ultimate_enchantment.apotheosis;

import com.chen1335.ultimate_enchantment.apotheosis.attachmentDatas.ApothBossAttachmentTypes;
import com.chen1335.ultimate_enchantment.apotheosis.attachmentDatas.ApothBossInfo;
...
public final class ApothBossEquipmentLoot {
    ...
    public static void appendEquipment(
        ...
        if (!entity.getPersistentData().getBooleanOr(APOTH_BOSS_KEY, false)) {
            return;
        }
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (!fresh.isEmpty()) {
                entity.spawnAtLocation((ServerLevel) entity.level(), fresh);
            }
        }
    }
