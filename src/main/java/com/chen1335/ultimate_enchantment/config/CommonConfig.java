...
public class CommonConfig {
    ...
    static {
        ...
        legendBlackList = builder
                ...
                .defineListAllowEmpty(
                        ...
                        List.of(Attributes.SCALE.getKey().identifier().toString()),
                        () -> "",
    ...
    private static void bake() {
        ...
        for (String id : legendBlackList.get()) {
            Attribute attribute = BuiltInRegistries.ATTRIBUTE.get(Identifier.parse(id)).map(Holder::value).orElse(null);
            if (attribute != null) {
